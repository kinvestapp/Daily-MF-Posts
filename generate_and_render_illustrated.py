...
def generate_illustration(theme, character_key):
    ...
    prompt = (
        ...
        "notebook page with faint ruled horizontal lines across the whole page and a spiral binding "
        "running down the far left edge. "
        ...
        "IMPORTANT: leave the top-left corner (roughly the top 160px and left 220px) as completely "
        "plain, unmarked notebook paper with NO spiral rings and no illustration elements there — "
        "this area is reserved for a logo overlay, so the spiral binding should only begin below "
        "and to the right of that corner. "
        "IMPORTANT: leave the bottom third of the page as lightly-ruled but otherwise empty notebook "
