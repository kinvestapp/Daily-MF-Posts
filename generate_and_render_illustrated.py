...
def generate_illustration(theme, character_key):
    ...
    prompt = (
        f"Using {char_desc}, illustrate a new scene about: {theme}. "
        "Keep the exact same character design, art style, and color palette as the reference image. "
        "Square 1:1 composition. Leave the bottom third of the image relatively simple/uncluttered "
        "since text will be overlaid there. No text, no words, no logos in the image itself. "
